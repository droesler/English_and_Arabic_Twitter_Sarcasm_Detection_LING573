...
if __name__ == '__main__':
  ...
  model1_val_result_path = "results/D4/primary/devtest/sub_models/model1_metrics.txt"
  model2_val_result_path = "results/D4/primary/devtest/sub_models/model2_metrics.txt"
  model3_val_result_path = "results/D4/primary/devtest/sub_models/model3_metrics.txt"
  model4_val_result_path = "results/D4/primary/devtest/sub_models/model4_metrics.txt"
  model5_val_result_path = "results/D4/primary/devtest/sub_models/model5_metrics.txt"

  model1_test_result_path = "results/D4/primary/evaltest/sub_models/model1__metrics.txt"
  model2_test_result_path = "results/D4/primary/evaltest/sub_models/model2__metrics.txt"
  model3_test_result_path = "results/D4/primary/evaltest/sub_models/model3__metrics.txt"
  model4_test_result_path = "results/D4/primary/evaltest/sub_models/model4__metrics.txt"
  model5_test_result_path = "results/D4/primary/evaltest/sub_models/model5__metrics.txt"
