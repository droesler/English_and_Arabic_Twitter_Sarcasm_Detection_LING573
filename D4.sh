...
LC_ALL=en_US.UTF-8 python src/model_runner.py test data/balanced_validation_Ar.csv  outputs/D4/adaptation/devtest/ar_pred_output.csv  results/D4/adaptation/devtest/ar_metrics.txt --model-class CamelbertMixClassifier  --log-dir /home2/diazhang/LING573/logging/ --experiment-name diazhang --experiment-version 1 -c runner_config.json
LC_ALL=en_US.UTF-8 python src/model_runner.py test data/task_A_Ar_test_column_renamed.csv  outputs/D4/adaptation/evaltest/ar_pred_output.csv  results/D4/adaptation/evaltest/ar_metrics.txt --model-class CamelbertMixClassifier  --log-dir /home2/diazhang/LING573/logging/ --experiment-name diazhang --experiment-version 1 -c runner_config.json