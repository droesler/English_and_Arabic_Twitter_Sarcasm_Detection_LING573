...
LC_ALL=en_US.UTF-8 python src/model_runner.py train data/balanced_train_Ar.csv --accelerator gpu --devices 1 --model-class CamelbertMixClassifier --log-dir /home2/diazhang/LING573/logging \
